...
export const CHANGELOG = [
  {
    ...
    changes: [
      ...
      "If you leave the app open for a while and a new version comes out, a banner now shows up letting you know — tap Refresh to grab it. Before this, an already-open tab would just keep running whatever it loaded at open time indefinitely.",
