import { ICON_LINK, ICON_QUOTE, ICON_NOTE, ICON_POEM, ICON_BOOK, ICON_PODCAST, ICON_VIDEO, ICON_IMAGE, ICON_OTHER } from "./icons.js";
...
export const SNIPPET_TYPES = [
  ...
  { id: "quote", label: "Quote", icon: ICON_QUOTE, contentPlaceholder: "The quote itself…", long: true, hasAuthor: true },
  { id: "note", label: "Note", icon: ICON_NOTE, contentPlaceholder: "Your note…", long: true },
  { id: "poem", label: "Poem", icon: ICON_POEM, contentPlaceholder: "The poem…", long: true, hasTitle: true, hasAuthor: true },
  ...
  { id: "image", label: "Image", icon: ICON_IMAGE, contentPlaceholder: "Caption (optional)", long: false },
